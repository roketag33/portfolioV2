...
## UI & UX / Fixes
- [x] [Lab] Mobile : Ajouter une description car le hover ne marche pas en mobile
...
- [x] [contact] ajouter des achievements
- [x] [contact] ajouter des animations 

## Site Improvements (Pending)
...
- [x] Investigator Mobile UX Issues (Browser Verification) <!-- id: 18 -->

- [x] [site]  le responsive est pas bon sur tout les appareils mobile faut refaire une passe
